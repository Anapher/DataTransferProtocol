...
namespace DataTransferProtocol.NetSerializer.TypeSerializers
{
    public class DictionarySerializer : IStaticTypeSerializer
    {
        ...
        public static void WritePrimitive<TKey, TValue>(Serializer serializer, Stream stream,
        ...
        public static void ReadPrimitive<TKey, TValue>(Serializer serializer, Stream stream,
