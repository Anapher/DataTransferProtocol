...
namespace DataTransferProtocol.NetSerializer.TypeSerializers
{
    public class GenericSerializer : IDynamicTypeSerializer
    {
        ...
        public void GenerateReaderMethod(Type type, CodeGenContext ctx, ILGenerator il)
        {
            ...
            if (type.IsClass)
            {
                ...
                var guo = typeof (System.Runtime.Serialization.FormatterServices).GetMethod("GetUninitializedObject",
            ...
            {
                var miOnDeserialization =
                    typeof (System.Runtime.Serialization.IDeserializationCallback).GetMethod("OnDeserialization",
